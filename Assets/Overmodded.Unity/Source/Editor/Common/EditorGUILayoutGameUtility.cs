...
namespace Overmodded.Unity.Editor.Common
{
    ...
    /// </summary>
    public static class EditorGUILayoutGameUtility
    {
        ...
        public static int MaterialSettingsField(string label, int materialIdentity) => DatabaseItemField<MaterialsDatabase, MaterialSettings>(label, materialIdentity);
        public static int WeaponSettingsField(string label, int weaponIdentity) => DatabaseItemField<WeaponDatabase, WeaponSettings>(label, weaponIdentity);
        public static int AnimationSettingsField(string label, int animationIdentity) => DatabaseItemField<CharacterAnimatorDatabase, CharacterAnimatorSettings>(label, animationIdentity);
        ...
        public static int DatabaseItemField<TDatabase, TItem>(string label, int itemIdentity) where TDatabase : DatabaseManager<TItem> where TItem : DatabaseItem
        {
            ...
            {
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField(label, "List is empty.");
            ...
            if (GUILayout.Button("Refresh Database", EditorStyles.miniButton, GUILayout.Width(105)))
